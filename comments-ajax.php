...
if ( $flood_die ) {
    err(__('You are posting comments too quickly.  Slow down. 悠着点~ '));
	}
}
...
?>
	<li class="replycomment" id="li-comment-<?php comment_ID(); ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment-body">
		<div class="comment-author vcard">
			<?php echo get_avatar( $comment, 40,$default,$alt=get_comment_author($id)); ?>
			<?php printf( __( '<cite class="fayan">%s</cite>'), get_comment_author_link() ); ?>在 
			<span class="commentmetadata"> <?php time_ago() ?> </span> 说：
		</div>
